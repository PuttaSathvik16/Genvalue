...
export function buildPasswordResetOtpEmailHtml({ otp, email, expiresMinutes = 10 }) {
...
<head>
  ...
  <title>GenValue Academy — Password Reset Code</title>
</head>
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:520px;background-color:#F6F1E4;border:1px solid rgba(0,0,0,0.1);border-radius:24px;overflow:hidden;box-shadow:0 12px 40px rgba(13,27,42,0.12);">
          <tr>
            <td style="background-color:#0D1B2A;padding:28px 32px;text-align:center;">
              <p style="margin:0 0 6px;font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:#E8622E;">★ Reset Your Password</p>
              <h1 style="margin:0;font-size:24px;font-weight:800;color:#ffffff;line-height:1.2;">
                ...
                <span style="display:block;font-size:14px;font-weight:600;color:#94A3B8;margin-top:6px;">Student LMS Portal</span>
              </h1>
            </td>
          </tr>
          <tr>
            <td style="padding:32px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;line-height:1.6;color:#6B6558;">
                Use the one-time passcode below to reset the password for
                <strong style="color:#2A2A28;">${safeEmail}</strong>.
              </p>
              <div style="text-align:center;margin:0 0 24px;padding:24px;background-color:#ffffff;border:1px dashed rgba(232,98,46,0.25);border-radius:16px;">
                ...
                <p style="margin:0;font-size:36px;font-weight:800;letter-spacing:0.28em;color:#E8622E;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;">${safeOtp}</p>
              </div>
...
export function buildPasswordResetOtpEmailText({ otp, email, expiresMinutes = 10 }) {
  return [
    "GenValue Academy — Password Reset",
    "",
